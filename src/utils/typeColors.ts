...
export const TYPE_COLORS = {
  ...
  electric: { color: '#DFA200', gradient: 'from-amber-400 via-amber-500 to-amber-600', glow: 'rgba(223,162,0,0.4)' },
  grass: { color: '#1F8A67', gradient: 'from-emerald-600 via-green-700 to-emerald-800', glow: 'rgba(31,138,103,0.35)' },
  ice: { color: '#3BAFC3', gradient: 'from-cyan-500 via-teal-500 to-emerald-500', glow: 'rgba(59,175,195,0.4)' },
  ...
  bug: { color: '#5F8A1F', gradient: 'from-lime-700 via-green-700 to-emerald-800', glow: 'rgba(95,138,31,0.35)' },
