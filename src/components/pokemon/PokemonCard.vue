...
import PokemonInfoPanel from '@/components/pokemon/PokemonInfoPanel.vue'
import PokemonSpriteDisplay from '@/components/pokemon/PokemonSpriteDisplay.vue'
import PokemonHorizontalNav from '@/components/pokemon/PokemonHorizontalNav.vue'
import PokemonVerticalNav from '@/components/pokemon/PokemonVerticalNav.vue'
